# -*- coding: utf-8 -*-
#
# Rémy DANIEL documentation build configuration file, created by
# TYPO3 extension sphinx on Fri, 19 Sep 2014 11:19:34 +0200.
#
...
htmlhelp_basename = 'RémyDANIELdoc'
...
latex_documents = [
    ('Index', 'RémyDANIEL.tex', u'Rémy DANIEL',
     u'', 'manual'),
]
...
pdf_documents = [
    ('Index', 'RémyDANIEL', u'Rémy DANIEL',
     u''),
]
...
texinfo_documents = [
    ('Index', 'RémyDANIEL', u'Rémy DANIEL',
     u'', 'Rémy DANIEL', 'One line description of project.',
     'Miscellaneous'),
]
